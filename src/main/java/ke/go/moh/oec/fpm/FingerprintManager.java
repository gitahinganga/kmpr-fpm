...
/**
 * This interface specifies the contract between sundry fingerprinting SDKs and OpenEMRConnect
 * software modules. Implementations must be written to wrap any given SDK in order for it to
 * plug into OpenEMRConnect software modules.
 *
